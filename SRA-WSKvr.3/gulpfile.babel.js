...
var
  ...
  partialSources = ['app/partials/*.scss'],
...
gulp.task('clean', () => del(['.tmp', outputDir + '/*', '!' + outputDir + '/.git'], {
  dot: true
}));
...
gulp.task('copy-sw-scripts', () => {
  return gulp.src(['node_modules/sw-toolbox/sw-toolbox.js', 'app/scripts/sw/runtime-caching.js'])
    .pipe(gulp.dest(outputDir + 'scripts/sw'));
});
